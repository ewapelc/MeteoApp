...
# GDAL_LIBRARY_PATH = os.path.join(VENV_BASE, 'Lib\\site-packages\\osgeo\\gdal300.dll')
...
SECRET_KEY = 'django-insecure-*z0pk8k-v@xym)dkxl6pdl29k&!bl3^p%h3phtecd&a2f4k#b&'
